...
START TRANSACTION;
USE `bd_ventas`;
INSERT INTO `bd_ventas`.`cliente` (`id`, `nombre`, `email`, `edad`, `activo`, `password`) VALUES (1, 'Ana', 'a@a.com', 19, 1, '0000');
INSERT INTO `bd_ventas`.`cliente` (`id`, `nombre`, `email`, `edad`, `activo`, `password`) VALUES (2, 'Juan', 'j@j.com', 42, 0, '1234');
...
START TRANSACTION;
USE `bd_ventas`;
INSERT INTO `bd_ventas`.`producto` (`id`, `nombre`, `precio`, `stock`) VALUES (1, 'Camiseta', 10, 100);
...
START TRANSACTION;
USE `bd_ventas`;
INSERT INTO `bd_ventas`.`compra` (`id`, `cliente_id`, `producto_id`, `fecha`, `cantidad`) VALUES (1, 1, 1, DEFAULT, 1);
